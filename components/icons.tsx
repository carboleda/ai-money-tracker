...
export const IconBxBrain: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export const IconArrowUp: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
...
export const IconArrowDown: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 16 16"
...
export const IconArrowsExchangeAltV: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
